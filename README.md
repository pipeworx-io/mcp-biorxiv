...
`tools/list` at `https://gateway.pipeworx.io/biorxiv/mcp` returns the tools in the table
...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/details \
  -H 'Content-Type: application/json' \
  -d '{"server":"biorxiv","doi":"10.1101/2024.01.15.575982"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/details`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
